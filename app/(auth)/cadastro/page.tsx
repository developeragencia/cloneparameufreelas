...
function CadastroPageInner() {
  ...
  const handleSocialLogin = async (provider: string) => {
    ...
    await signIn(provider, { callbackUrl: '/dashboard/cliente' })
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-8 px-6">
      <div className="w-full max-w-lg">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-gray-900">Criar conta grátis</h1>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${
                tipo === 'cliente'
                  ? 'border-[#00aeef] bg-[#00aeef] bg-opacity-5 text-[#00aeef]'
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            <button
              ...
              className="flex items-center justify-center gap-2 border-2 border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition-all hover:shadow-md disabled:opacity-60 text-sm"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-[#00aeef] bg-white"
              />
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-[#00aeef] bg-white"
                />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#00aeef] bg-white"
                >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-[#00aeef] pr-12 bg-white"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#00aeef] hover:bg-[#0099d4] text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 shadow-lg hover:shadow-xl text-base mt-2"
            >
              {loading ? (
